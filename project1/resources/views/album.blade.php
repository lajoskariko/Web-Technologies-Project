<x-app-layout>
    ...
    <div class="music-grid">
        ...
        <div class="album-card" data-src="{{ asset('music/' . $album->file) }}" data-title="{{ $album->title }}" data-artist="{{ $album->artist }}">
            <img src="{{ asset('images/covers/' . $album->cover_image) }}" alt="{{ $album->title }}">
            <h3>{{ $album->title }}</h3>
